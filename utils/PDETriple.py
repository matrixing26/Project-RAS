...
class PDETripleCartesianProd(Data):
    ...
    def __init__(self, X_train: np.ndarray, y_train: np.ndarray, X_test: np.ndarray, y_test: np.ndarray, func_space = None):
    ...
    def losses(self, targets, outputs, loss_fn: List[Callable[[Any], Any]] | Callable[[Any], Any], inputs, model, aux = None):

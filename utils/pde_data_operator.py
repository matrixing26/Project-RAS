...
import deepxde.deepxde.config as config

from deepxde.deepxde.utils import run_if_all_none

class PDEOperator(dde.data.Data):
...
class PDEOperatorCartesianProd(Data):
    ...
    def __init__(
        ...
        self.train_sampler = dde.data.BatchSampler(self.num_func, shuffle=True)
        self.train_next_batch()
        self.test()
